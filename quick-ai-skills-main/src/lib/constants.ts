...
export const ENV = {
  ...
  ERROR_REPORTING_ENDPOINT: import.meta.env.VITE_ERROR_REPORTING_ENDPOINT || '/api/monitoring/errors',
  PERFORMANCE_MONITORING_ENDPOINT: import.meta.env.VITE_PERFORMANCE_MONITORING_ENDPOINT || '/api/monitoring/performance',
  ANALYTICS_ENDPOINT: import.meta.env.VITE_ANALYTICS_ENDPOINT || '/api/monitoring/analytics',
  CRASH_REPORTING_ENDPOINT: import.meta.env.VITE_CRASH_REPORTING_ENDPOINT || '/api/monitoring/crashes',
  
  // Build info
  BUILD_ID: import.meta.env.VITE_BUILD_ID || 'unknown',
  
  // Performance Configuration
  PERFORMANCE_CACHE_EXPIRY: parseInt(import.meta.env.VITE_PERFORMANCE_CACHE_EXPIRY || '300000'), // 5 minutes
  PERFORMANCE_MAX_CACHE_SIZE: parseInt(import.meta.env.VITE_PERFORMANCE_MAX_CACHE_SIZE || '100'),
  PERFORMANCE_LAZY_LOAD_THRESHOLD: parseInt(import.meta.env.VITE_PERFORMANCE_LAZY_LOAD_THRESHOLD || '100'),
  PERFORMANCE_SLOW_LOAD_THRESHOLD: parseInt(import.meta.env.VITE_PERFORMANCE_SLOW_LOAD_THRESHOLD || '3000'),
  PERFORMANCE_SLOW_RENDER_THRESHOLD: parseInt(import.meta.env.VITE_PERFORMANCE_SLOW_RENDER_THRESHOLD || '100'),
  PERFORMANCE_MEMORY_WARNING_THRESHOLD: parseInt(import.meta.env.VITE_PERFORMANCE_MEMORY_WARNING_THRESHOLD || '80'),
  PERFORMANCE_ENABLE_CACHING: import.meta.env.VITE_PERFORMANCE_ENABLE_CACHING !== 'false',
  PERFORMANCE_ENABLE_LAZY_LOADING: import.meta.env.VITE_PERFORMANCE_ENABLE_LAZY_LOADING !== 'false',
  PERFORMANCE_ENABLE_CODE_SPLITTING: import.meta.env.VITE_PERFORMANCE_ENABLE_CODE_SPLITTING !== 'false',
  PERFORMANCE_ENABLE_BUNDLE_ANALYSIS: import.meta.env.VITE_PERFORMANCE_ENABLE_BUNDLE_ANALYSIS !== 'false',
  
  // Encryption Configuration
  ENCRYPTION_ALGORITHM: import.meta.env.VITE_ENCRYPTION_ALGORITHM || 'AES-GCM',
  ENCRYPTION_KEY_LENGTH: parseInt(import.meta.env.VITE_ENCRYPTION_KEY_LENGTH || '256'),
  ENCRYPTION_IV_LENGTH: parseInt(import.meta.env.VITE_ENCRYPTION_IV_LENGTH || '12'),
  ENCRYPTION_SALT_LENGTH: parseInt(import.meta.env.VITE_ENCRYPTION_SALT_LENGTH || '16'),
  ENCRYPTION_ITERATIONS: parseInt(import.meta.env.VITE_ENCRYPTION_ITERATIONS || '100000'),
  ENCRYPTION_ENABLE_COMPRESSION: import.meta.env.VITE_ENCRYPTION_ENABLE_COMPRESSION !== 'false',
  ENCRYPTION_ENABLE_INTEGRITY_CHECK: import.meta.env.VITE_ENCRYPTION_ENABLE_INTEGRITY_CHECK !== 'false',
  ENCRYPTION_ENABLE_KEY_ROTATION: import.meta.env.VITE_ENCRYPTION_ENABLE_KEY_ROTATION !== 'false',
  ENCRYPTION_KEY_ROTATION_INTERVAL: parseInt(import.meta.env.VITE_ENCRYPTION_KEY_ROTATION_INTERVAL || '86400000'), // 24 hours
  ENCRYPTION_SECURE_TRANSMISSION_TIMEOUT: parseInt(import.meta.env.VITE_ENCRYPTION_SECURE_TRANSMISSION_TIMEOUT || '30000'),
  ENCRYPTION_SECURE_TRANSMISSION_RETRIES: parseInt(import.meta.env.VITE_ENCRYPTION_SECURE_TRANSMISSION_RETRIES || '3'),
} as const;
