      ...
      scoreRanges: [
        {
          min: 90,
          max: 100,
          template: "🎉 Outstanding work! You've demonstrated excellent understanding of the concepts. Your code is clean, well-structured, and shows great attention to detail. Keep up this fantastic work!",
          suggestions: [
